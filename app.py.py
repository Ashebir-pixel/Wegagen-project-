...
with st.sidebar:
    st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Wegagen_Bank_logo.svg/200px-Wegagen_Bank_logo.svg.png",
             use_column_width=True, caption="Wegagen Bank S.C.")
    st.markdown("---")
